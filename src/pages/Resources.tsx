...
// --- Constants ---
const API_BASE_URL = apiUrl("/api/resources");
                        ...
                        {pageNumbers.map((page, index) => (
                            page === '...' ? (
                                ...
                                <button
                                    ...
                                    className={`inline-flex items-center px-3 py-1.5 text-xs font-medium rounded transition duration-150 ${pagination.current_page === page
